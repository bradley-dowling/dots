...
// ** The main program runs through Dots.java. MyPanel.java is an extension
// ** of the JPanel class and is the main 'game board' that stores all of the
// ** methods and information regarding the status of the game of 'dots and 
// ** boxes'.
...
public class MyPanel extends JPanel {
	...
	// resetBoard() runs if the user presses the 'restart'. The fields in the boxArray are all reset
	// but not re-created.
	public void resetBoard() {
		for (int row = 0; row < totalRows; row++) {
			for (int column = 0; column < totalColumns; column++) {
				boxArray[row][column].resetFields();
			}
		}
		player1Score = 0;
		player2Score = 0;
	...
	// standard accessors for some of the private propertjies of MyPanel...
